...
//-------------- encriptar el PASSWORD Y GUARDAR LA IMG ---------------//

//-------------- se puede usar un refresh para esperar que se redirija en cierto tiempo -------------//
?>
...
?>
	...
	<div class="form-container sign-in-container">
		<form method='POST' action="#">
			...
			<button type="submit" name="login">Iniciar Secion</button>
	<?php
