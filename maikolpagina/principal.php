       ...
       <div class="datos">
             ...
             <div class="cajaDeSubirFoto">
                <form class="for" action="" method="POST" enctype="multipart/form-data">
                      <div class="header3">
                        <img class="x" src="f.png">
                        <h2>Subir fotos</h2>
                        <button class="s" name="subir" type="submit">Publicar</button>
                       </div> 

                           <div class="div-file">
                              <img class="preliminar" src="https://img.rawpixel.com/s3fs-private/rawpixel_images/website_content/rm33-chim-31-i-wall_2.jpg?w=800&dpr=1&fit=default&crop=default&q=65&vib=3&con=3&usm=15&bg=F4F4F3&ixlib=js-2.2.1&s=3f85e276f7f3a24ec69587f0f56df9f3" id="file" alt="">
                           ...
                           <div class="div-boton">  
                                ...
                                <textarea id="c1" class="input-comentario" type="text" name="titulo" placeholder="Agrega un pie de foto"></textarea>
                           </div>
                           <?php
             ...
             <!-- <img class="img-formato" src="formato.png" alt=""> -->
...
<?php $cont2++; ?>
  <article class="box" id="<?php echo "$cont2"?>">
      ...
      <a href="#d"><img class="close"  src="x.png" alt=""></a>
              ...
              <img class="delet" src="eliminar.png" alt="">
          </article>
        <?php } ?>
